...
while ($row = $result->fetch_assoc()) {
    if (isset($_GET['id']) && $row['id'] == $_GET['id']) {
        ...
        echo "<td><input type='text' class='table-res' name='email' value='" . $row["email"] . "'></td>";
        echo "<td><input type='text' class='table-res' name='address' value='" . $row['address'] . "'></td>";
        echo "<td><input type='number' class='table-res' name='phnum' value='" . $row["phnum"] . "'></td>";
        ...
        echo "<td class='form-deco'>" . $row['email'] . "</td>";
        echo "<td class='form-deco'>" . $row['address'] . "</td>";
        echo "<td class='form-deco'>" . $row['phnum'] . "</td>";
